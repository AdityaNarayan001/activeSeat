...
class ParamPanel(QWidget):
    ...
    def _build_ui(self):
        ...
        self.viscous_friction = _dspin(0.01, 0, 1.0, 0.005, 4, "N·m·s/rad")
        ...
        self.Q1 = _dspin(500000, 0, 1e8, 10000, 0)
        self.Q2 = _dspin(100, 0, 1e6, 10, 1)
        self.Q3 = _dspin(1000000, 0, 1e8, 10000, 0)
        self.Q4 = _dspin(100, 0, 1e6, 10, 1)
        self.R_val = _dspin(0.000001, 1e-10, 100, 0.0000001, 8)
